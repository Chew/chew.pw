class Sports::MlbController < SportsController
  ...
  def mlb
    @info = JSON.parse(RestClient.get("https://statsapi.mlb.com/api/v1/standings?leagueId=103,104&season=#{params[:season] || Time.now.year}&standingsTypes=regularSeason&hydrate=division,team", 'User-Agent': DUMMY_USER_AGENT))['records']
    teams = {}
